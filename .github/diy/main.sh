...
git clone --depth 1 https://github.com/sirpdboy/sirpdboy-package && mv -n sirpdboy-package/luci-app-dockerman sirpdboy-package/luci-app-koolproxyR ./ ; rm -rf sirpdboy-package
